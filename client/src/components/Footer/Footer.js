                    ...
                    <div className="col-xl-4 col-lg-4 mb-50">
                        <div className="footer-widget">
                            ...
                            <div className="footer-text">
                                <p>At BINARY BLOGS , we're dedicated to fostering a supportive environment where you can grow your skills, 
                ...
                <div className="row">
                    <div className="col-xl-6 col-lg-6 text-center text-lg-left">
                        <div className="copyright-text">
                            <p>Copyright &copy; 2024, All Right Reserved <a href="/">Binary-blogs</a></p>
                        </div>
                    </div>
